#!/usr/bin/env python3
# Batch Peak Fitting Module for RamanLab
"""
...
import os
import sys
# Add the current directory to the path to ensure we can import the Density package
current_dir = os.path.dirname(os.path.abspath(__file__))
if current_dir not in sys.path:
    sys.path.insert(0, current_dir)

try:
    from Density import RamanDensityAnalyzer
except ImportError:
    # Fallback to the original method if the package import fails
    sys.path.append(os.path.join(current_dir, 'Density'))
