...
class UpdateChecker:
                ...
                if self._is_newer_version(latest_version, self.current_version):
                    ...
                    if show_no_updates:
                        messagebox.showinfo(
                            ...
                            f"You are running the latest version of ClaritySpectra ({self.current_version})."
                        )
    ...
    def show_update_dialog(self, update_info):
        ...
        dialog = tk.Toplevel()
        dialog.title("ClaritySpectra Update Available")
    ...
    def _auto_update_git(self, parent_dialog):
        ...
        def update_thread():
            try:
                ...
                status_label = ttk.Label(progress_frame, text="Updating ClaritySpectra...")
                ...
                if result.returncode == 0:
                    messagebox.showinfo(
                        "Update Successful",
                        "ClaritySpectra has been updated successfully!\n"
    ...
    def _copy_git_command(self):
        ...
        try:
            ...
            messagebox.showinfo(
                ...
                "Run 'git pull' in your ClaritySpectra directory to update."
            )
        except ImportError:
            # Fallback if pyperclip not available
            messagebox.showinfo(
                "Git Command",
                "To update manually, run this command in your ClaritySpectra directory:\n\n"
                "git pull\n\n"
